...
import tagsPageInitialPropsTqLuResource from '../../../resources/tags-page-initial-props-tq_lu'
import tagsPageInitialPathsTqJResource from '../../../resources/tags-page-initial-paths-tq_-j'
...
export async function getStaticProps(context) {
  try {
    const response = await tagsPageInitialPropsTqLuResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await tagsPageInitialPathsTqJResource({
      content_type: 'tags',
    })
